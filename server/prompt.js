...
var jobs = ["secret agent", "spy", "bank robber", "thief", "mastermind", "thug", "heavy", "criminal", "robber", "burglar", "car thief", "cop", "policeman", "detective", "private investigator", "police chief", "paramedic", "doctor", "nurse", "insurance salesman", "car salesman", "racer", "dancer", "businessman", "CEO", "celebrity", "socialite", "vampire"];
...
var makePrompt = function() {
    ...
    prompt = "When a " + personA.gender + " " + personA.job + " meets the " + personB.gender + " " + personB.job + " of their dreams, will they find each other again after the " + activity + "?";
    return prompt;
};
